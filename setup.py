...
setup(
    ...
    version='0.0.1',
    description='RichFilemanager blueprint for Flask web applications',
    ...
    download_url='https://github.com/stevelittlefish/flaskfilemanager/archive/v0.0.1.tar.gz',
    keywords=['flask', 'jinja2', 'filemanager'],
    license='Apache',
    classifiers=[
